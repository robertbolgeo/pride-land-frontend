export default function Slogan() {
   ...
   <div className="flex flex-col gap-10 flex-1 items-center justify-center pb-10 md:py-24">
      <h2 className="text-brown text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl max-w-[1200px] mx-auto w-full text-center font-semibold">Find your <span className="text-primary">Open Space </span>
         <br/>
